        ...
        <div className="mint-status-info">
          ...
          {transaction?.transactionHash && (
            <div className="mint-transaction">
              <span className="mint-transaction-label">Transaction:</span>
              <a
                href={`https://testnet.verbwire.com/tx/${transaction.transactionHash}`}
                target="_blank"
                rel="noopener noreferrer"
                className="mint-transaction-link"
              >
          ...
          {transaction?.nftTokenId && (
            <div className="mint-transaction">
              <span className="mint-transaction-label">NFT Token:</span>
              <a
                href={`https://testnet.verbwire.com/token/${transaction.nftTokenId}`}
                target="_blank"
                rel="noopener noreferrer"
                className="mint-transaction-link"
              >
